...
import '../../domain/entity/movie_detial.dart';
...
class MovieDetailContent extends StatelessWidget {
  ...
  builder: (context, state) {
    switch(state.movieDetailStates)
    {
              ...
              background: FadeIn(
                ...
                child: ShaderMask(
                  ...
                  child: CachedNetworkImage(
                    ...
                    imageUrl: ApiConstant.imageUrl(state.movieDetail!.backdropPath),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
  ...
  builder: (context, state) {
    return SliverGrid(
      delegate: SliverChildBuilderDelegate(
        (context, index) {
          final recommendation = state.recommendationDetail[index];
          return FadeInUp(
            from: 20,
            duration: const Duration(milliseconds: 500),
            child: ClipRRect(
